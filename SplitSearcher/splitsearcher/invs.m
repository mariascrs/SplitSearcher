InvariantsFromWeierstrassPoints:=function(as,mulcount)
    
    // -----------------------------------------------------------------------------------------------
    // INPUT: A vector "as" which defines a genus 2 curve C (these are its Weierstrass points) and the
    //          current multiplciation count.
    // OUTPUT: The Igusa--Clebsch invariants alpha as normalised in Lemma 2, and an updated multiplication count.
    // -----------------------------------------------------------------------------------------------
