...
intrinsic QuadraticsFromWeierstrass(as::SeqEnum, mulcount::RngIntElt) -> SeqEnum, RngIntElt
{Returns all quadratic splittings of Weierstrass points

Input
-----
as::SeqEnum
  Weierstrass points of a genus 2 curve C
mulcount::RngIntElt
  Current mul count
...
------
SeqEnum
  Sequence of all quadratic splittings of the Weierstrass sextic
RngIntElt 
  Updated multiplication count 
}
...
intrinsic InvariantsFromQuadratics(quadratics::SeqEnum, mulcount::RngIntElt) -> SeqEnum, RngIntElt
{Outputs IC invariants of all (2,2)-isogenous Jacobians

Input
----- 
quadratics::SeqEnum
  A quadratic splitting of a Weierstrass sextic and multiplication count
mulcount::RngIntElt

Output
------
SeqEnum
  The Igusa--Clebsch invariants of the (2,2)-isogenous Jacobian corresponding to the splitting
RngIntElt
  Updated mulcount
}
...
intrinsic IsogenousInvariantsFromWeierstrass(as::SeqEnum, mulcount::RngIntElt) -> SeqEnum, RngIntElt
{The Igusa--Clebsch invariants of all the (2,2)-isogenous Jacobians from Jac(C)
...
RngIntElt
  Updated mulcount
    ...
    for q in quadratics do
        ...
        inv_denoms, mulcount := BatchMontgomeryInversion(denoms, mulcount);
